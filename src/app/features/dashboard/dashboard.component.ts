    ...
    <div class="row g-4">
        ...
        <div class="card border-0 shadow-sm p-3">
          <div class="card-body">
            ...
            <div class="d-flex align-items-center mt-2">
              <span class="badge bg-success-subtle text-success me-2">● Online</span>
      ...
      <div class="col-md-4">
        <div class="card border-0 shadow-sm p-3">
          <div class="card-body">
            ...
            <h4 class="mt-2 text-dark">Neon PostgreSQL</h4>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 mt-4">
        <div class="card border-0 shadow-sm p-4">
          <h5 class="fw-bold mb-3">Welcome to the ixcamper Console</h5>
          <p class="text-muted">Your full-stack application is successfully communicating through the Spring Cloud Gateway.</p>
          <hr>
