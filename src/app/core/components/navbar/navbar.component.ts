		...
		<nav class="navbar navbar-expand-lg border-bottom py-3">
			<div class="container-fluid px-4">
				...
				<div class="collapse navbar-collapse" id="ixcamperNav">
					...
					>
						<span
							class="navbar-text text-white-50 small mb-2 mb-lg-0 me-lg-4 d-flex align-items-center"
						>
							<i class="bi bi-person-circle me-2 fs-5 text-white-50"></i>
							<span
								>Signed in as
								<strong class="text-white ms-1">{{
						...
						<div
							class="vr d-none d-lg-block bg-white opacity-25 me-3"
							style="height: 20px;"
						></div>
